...
An implementation of the UTXO model, similar to Bitcoin, implemented on the Substrate framework.

## Getting Started

Follow the steps below to get started with the UTXO blockchain
:hammer_and_wrench:
...
Use Rust's native `cargo` command to build and launch the UTXO node:
